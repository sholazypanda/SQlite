...
public  class InitClass {
	public static long columnsLength;
	public static long tablesLength;
	public static long schemaLength;
	public static void makeSchemas() {
		try {
			/*
			...
			schemaLength=schemataTableFile.length();
			/*
			...
			tablesTableFile.writeByte("\n".length());
			tablesTableFile.writeBytes("\n");
			tablesLength=tablesTableFile.length();
			/*
			...
			columnsTableFile.writeByte("information_schema".length()); // TABLE_SCHEMA
			columnsTableFile.writeBytes("information_schema");
			columnsTableFile.writeByte("TABLE".length()); // TABLE_NAME
			...
			columnsTableFile.writeByte("information_schema".length()); // TABLE_SCHEMA
			columnsTableFile.writeBytes("information_schema");
			columnsTableFile.writeByte("COLUMN".length()); // TABLE_NAME
			columnsTableFile.writeBytes("COLUMN");
			columnsTableFile.writeByte("TABLE_SCHEMA".length()); // COLUMN_NAME
			columnsTableFile.writeBytes("TABLE_SCHEMA");
			columnsTableFile.writeInt(1); // ORDINAL_POSITION
			columnsTableFile.writeByte("varchar(64)".length()); // COLUMN_TYPE
			...
			columnsTableFile.writeByte("\n".length());
			columnsTableFile.writeBytes("\n");
			columnsLength=columnsTableFile.length();
